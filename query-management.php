...
<div class="head-section" style="background-color: lightblue; display: flex;">
        ...
        <div class="hr-main" style="  display: flex; padding-top: 30px; padding-bottom: 30px;">
            <div class="total-tickets" style="border: 3px solid #fff; border-radius: 10px; padding: 10px 20px; margin-left: 100px;">
              <label style="color:gray;">Total Tickets</label>
                <br>
                <label style="padding: 5px 20px; color:purple;" for="" value="35" name="35">test</label>
            ...
            <div class="open-tickets" style=" border: 3px solid #fff; border-radius: 10px; margin-left: 10px; padding: 10px 10px;">
                <a href="" style="text-decoration:none; color: #000;">Open Tickets</a>
                <br>
                <label for="" value="10" name="10"></label>
                <!-- <input type="open" name="open">             -->
            </div>
            <div class="answered" style="border: 3px solid #fff; border-radius: 10px; margin-left: 10px; padding: 10px 10px;">
                <a href="" style="text-decoration:none; color: #000;">Answered</a>
                <br>
                <label for="" value="15" name="15"></label>
                <!-- <input type="answered" name="answered">    -->
            </div>
            
            <div class="pending" style=" border: 3px solid #fff; border-radius: 10px; margin-left: 10px; padding: 10px 10px;">
                <a href="" style="text-decoration:none; color: #000;">Pending</a>
                <br>
                <label for="" value="2" name="2"></label>
                <!-- <input type="pending" name="pending"> -->
            </div>
            <div class="declined" style=" border: 3px solid #fff; border-radius: 10px; margin-left: 10px; padding: 10px 20px;">
                <a href="" style="text-decoration:none; color: #000;">Declined</a>
                <br>        
                <label for="" value="3" name="3"></label>
                <!-- <input type="declined" name="declined"> -->
            </div>
        </div>

        <div style=" margin-top: 30px; text-align: center; margin-left: 280px;">
            <form method="post" >
                <button type="submit" name="logout" style="color: #fff; text-decoration: none; padding: 5px 10px; background-color: purple; border-radius: 14px; border: none; outline: none;">Logout</button>
            </form>    
